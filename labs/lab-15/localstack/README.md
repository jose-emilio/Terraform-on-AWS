# Laboratorio 15 — LocalStack: Automatización de Secretos "Zero-Touch"
...
aws kms list-aliases \
  --query 'Aliases[?AliasName==`alias/lab15-secrets`]'

aws kms describe-key \
  --key-id alias/lab15-secrets \
