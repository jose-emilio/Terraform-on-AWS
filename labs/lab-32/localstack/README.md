# Laboratorio 32 — LocalStack: API Serverless: Lambda, API Gateway v2 y Layers
...
Desde el directorio `lab32/localstack/`:
...
awslocal lambda list-layer-versions \
  --layer-name lab32-local-utils \
  --query 'LayerVersions[*].{Version:Version,ARN:LayerVersionArn}'

# Log group
awslocal logs describe-log-groups \
  --log-group-name-prefix /aws/lambda/lab32-local
```
