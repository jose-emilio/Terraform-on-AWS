# Ejemplo mínimo de infraestructura para validar el pipeline DevSecOps de lab-16.
#
...
resource "aws_kms_key" "demo" {
  description             = "CMK demo para validar el pipeline DevSecOps de lab-16"
  ...
  tags = {
    Project   = "lab16-pipeline-demo"
    ManagedBy = "terraform"
  }
}

resource "aws_kms_alias" "demo" {
  name          = "alias/lab16-pipeline-demo"
