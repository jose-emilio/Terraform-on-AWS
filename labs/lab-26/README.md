# Laboratorio 26 — Framework de Pruebas: Plan, Apply e Idempotencia
...
run "tags_are_applied" {
  ...
  assert {
    condition     = output.effective_tags["Project"] == "lab26-inttest"
